// This module is based on the work done by 20kdc in his RaptureUI mod:
// https://github.com/20kdc/decrossfuscator/blob/b5c4250aade5bf8d41b12ec7c346d49ba107b2a9/mods/raptureui/keybinding.js
// This exact code along with the notes was imported from the `input-api` mod,
// which shall be deprecated from now on.
//
// This module is needed basically because the developers use a local variable
...
// reference to that variable, so I had to copy cOpYrIgHtEd code, which is
...
// key K1 of action A1, you simply have to unbind alternative key K2 of the
// action A2 and bind K1 to that. _I could fix that_. But, this is a standard
// library, so fixing that felt intrusive in this context. So, apart from
